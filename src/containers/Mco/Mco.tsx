          ...
          <Container>
            <div className={styles.infoSection}>
              ...
              <div className={styles.infoSection__content}>
                <p>
                  Это инновационный проект ФНС России, предлагающий получение электронных чеков как от
                ...
                <ul>
                  ...
                  <li>Вы отсканировали QR-код на чеке в мобильном приложении «Проверка чеков».</li>
                </ul>
                <p>
                  В сервисе вы получаете возможность просмотреть чеки, а также экспортировать их в форматы PDF или
                  Excel.
                </p>
              </div>
            </div>
